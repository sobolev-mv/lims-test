...
{
  public sealed class CzlPloskRptParam : RptWithF1Param
  {
    public CzlPloskRptParam(string sourceXlsFile, string destXlsFile) : base(sourceXlsFile, destXlsFile)
    {}
  }

  public sealed class CzlPlosk : RptWithF1
  {

    protected override void DoWorkXls(object sender, DoWorkEventArgs e)
    {
      var prm = (e.Argument as CzlPloskRptParam);
    ...
    private Boolean RunRpt(CzlPloskRptParam prm, dynamic CurrentWrkSheet)
    {
      ...
      try{
        ...
        const string SqlStmt = "SELECT * FROM VIZ_PRN.CZL_NEPL_NEW ORDER BY 1";
        ...
        if (prm.TypeFilter == 1)
          CurrentWrkSheet.Cells[6, 3].Value = prm.GetFilter1Criteria();
