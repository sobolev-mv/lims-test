...
{
  public sealed class OutOfServiceMillRollsRptParam : Smv.Xls.XlsInstanceParam
  {
    public DateTime DateBegin { get; set; }
    public DateTime DateEnd { get; set; }
    public OutOfServiceMillRollsRptParam(string sourceXlsFile, string destXlsFile) : base(sourceXlsFile, destXlsFile)
    {}
  }

  public sealed class OutOfServiceMillRolls : Smv.Xls.XlsRpt
  {

    protected override void DoWorkXls(object sender, DoWorkEventArgs e)
    {
      var prm = (e.Argument as OutOfServiceMillRollsRptParam);
    ...
    private Boolean RunRpt(OutOfServiceMillRollsRptParam prm, dynamic CurrentWrkSheet)
    {
      ...
      try
      {
        ...
        const string sqlStmt1 = "SELECT * FROM VIZ_PRN.V_PU_VALKI_SPIS";
        ...
        CurrentWrkSheet.Cells[3, 4].Value = $"За период с {dtBegin:dd.MM.yyyy} по {dtEnd:dd.MM.yyyy}   списано: {cntRoll} валка(ов)";
