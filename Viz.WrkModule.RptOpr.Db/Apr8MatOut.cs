...
{
  public sealed class Apr8MatOutRptParam : Smv.Xls.XlsInstanceParam
  {
    public DateTime DateBegin { get; set; }
    public DateTime DateEnd { get; set; }
    public Apr8MatOutRptParam(string sourceXlsFile, string destXlsFile) : base(sourceXlsFile, destXlsFile)
    {}
  }

  public sealed class Apr8MatOut : Smv.Xls.XlsRpt
  {

    protected override void DoWorkXls(object sender, DoWorkEventArgs e)
    {
      var prm = (e.Argument as Apr8MatOutRptParam);
    ...
    private Boolean RunRpt(Apr8MatOutRptParam prm, dynamic CurrentWrkSheet)
    {
      ...
      try{
        ...
        //CurrentWrkSheet.Range["H1:L1"].ClearContents();
        CurrentWrkSheet.Cells[1, 1].Value = $"Список рулонов, прошедших АПР-8 за период с {dtBegin:dd.MM.yyyy HH:mm:ss} по {dtEnd:dd.MM.yyyy HH:mm:ss}";

        const string sqlStmt1 = "SELECT * FROM VIZ_PRN.V_APR8OUT";
